...
import digitalImg from "../Images/Gmain.jpg";
import DigitalTwin from "../Images/5G.png";
import Ellipse from "../svg/Ellipse 10.svg";
import arrow from "../svg/Arrow 1.svg";
import img1 from "../Images/2nd.jpg";
...
export default function Advancedexplained() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-black">
                    ...
                    <div className="max-w-7xl mx-auto mt-24">
                        <div className="max-w-2xl">
                            ...
                            <motion.p className="text-white text-base md:text-[20px] leading-relaxed max-w-xl" >
                                5G-Advanced is the next phase of 5G, offering enhanced connectivity, higher reliability, and smarter networks through AI/ML. It will enable advanced applications across industries, boost efficiency, and support more sustainable, high-performance networks.                            </motion.p>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                    ...
                    <div className="space-y-5 sm:space-y-6">
                        ...
                        <motion.p className="text-gray-300 text-[15px] sm:text-[16px] md:text-[18px] leading-relaxed">
                            5G has rapidly expanded, surpassing 4G in adoption and coverage. With 3GPP’s Release 15, it introduced faster speeds and low latency, enabling early use cases like AR, VR, and cloud gaming.
                            Releases 16 and 17 added support for Industrial IoT, energy-saving, and edge computing. Now, Release 18 marks the start of 5G-Advanced, bringing smarter, more efficient networks for industries and consumers alike.
                        </motion.p>
            ...
            <AdvanceDimention />
            <KeyEnhancements5GAdvanced items={items} />
            <FiveGExplainer
                imageSrc={city}
                onPlay={() => console.log("Play video")}
                ctaHref="/blog/5g-explainer"
            />
            ...
            <FiveGAdvancedCards
                ...
                left={{
                    title: "5G Advanced",
                    body:
                        "5G-Advanced, driven by AI and 3GPP standards like Release 18 and 19, will unlock powerful new capabilities in connectivity, XR, and precision technologies.",
                    thumbSrc: thumbLeft,
                    thumbAlt: "5GA logo",
                }}
                right={{
                    title: "5G-Advanced will transform our industry",
                    body:
                        "5G-Advanced will transform networks from 2025 by merging digital and physical worlds while boosting operational and environmental efficiency.",
                    thumbSrc: thumbRight,
                    thumbAlt: "city mosaic",
                }}
            />;
