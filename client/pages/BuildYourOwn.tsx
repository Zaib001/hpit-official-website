...
import digitalImg from "../Images/BYOS-main.png";
import DigitalTwin from "../Images/Build Your Own Secure &.png";
import Ellipse from "../svg/Ellipse 10.svg";
import arrow from "../svg/Arrow 1.svg";
import img1 from "../Images/communication.jpg";
...
import res1 from "@/Images/BYOS/r1.png";
import res2 from "@/Images/BYOS/r2.png";
import res3 from "@/Images/BYOS/r3.png";

import i2 from "../Images/DGT/i2.png";
import InsightSection from "@/components/InsightSection";

import i1 from "../Images/BYOS/i1.png";
import i2i from "../Images/BYOS/i2.png";
import i3 from "../Images/BYOS/i3.png";
...
import deco from "../Images/byos.png";
    ...
    const cards = [
        {
            ...
            desc: "Providing secure and exclusive network access for enterprises.",
        },
        {
            img: i2i,
            title: "ENHANCED SECURITY",
            desc: "Safeguarding sensitive data with private and controlled access.",
        },
        {
            img: i3,
            title: "SCALABLE SOLUTIONS",
            desc: "Adapting network capacity to meet growing business needs.",
        },
        {
            img: i2,
                    ...
                    <div className="max-w-7xl mx-auto mt-24">
                        <div className="max-w-2xl">
                            ...
                            <motion.h2 className="text-white text-3xl md:text-[56px] lg:text-5xl font-bold mb-8" >
                                Scalable Private Cellular Network
                            </motion.h2>
                            <motion.p className="text-white text-base md:text-[20px] leading-relaxed max-w-xl" >
                                Empower your business with lightning-fast, interference-free communication using private 4G and 5G networks designed for performance, security, and control.
                            </motion.p>
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
    ...
    <div className="space-y-5 sm:space-y-6">
      ...
      <motion.p className="text-gray-300 text-[15px] sm:text-[16px] md:text-[18px] leading-relaxed">
        A Private Cellular Network is a dedicated mobile network built specifically for an
        organization—offering the same performance as public 4G/5G but with enhanced security,
        control, and customization.
        <br />
        <br />
        Unlike public mobile networks, a private network operates on licensed, unlicensed, or shared
        spectrum (like CBRS or mmWave), ensuring dedicated bandwidth and zero interference—ideal for
        factories, hospitals, campuses, ports, warehouses, and smart cities.
      </motion.p>
    ...
    >
      ...
      />
            ...
            <IndustriesPrivateCellular/>
            <WhyChoosePrivateNetwork/>
            <ClientSuccessStory photoSrc={handshake} />
            <DeploymentProcess/>
            <WhyChoose artworkSrc={deco}/>
                ...
                <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-0 py-10">
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_1fr] gap-6 items-start">
                        ...
                        >
                            ...
                            <h3 className="text-lg sm:text-xl font-semibold">Building Private Networks</h3>
                            <p className="mt-3 text-white/75 text-sm leading-6">
Step-by-step insights into deploying scalable, secure private cellular systems.
Ideal for manufacturing, logistics, defense, and critical infrastructure.
                            </p>
                        ...
                        >
                            ...
                            <h3 className="text-lg sm:text-xl font-semibold">5G in Smart Hospitals</h3>
                            <p className="mt-3 text-white/75 text-sm leading-6">
North York General Hospital boosted efficiency using private 5G and AI.
See how private networks improved care and data-driven workflows.
                            </p>
