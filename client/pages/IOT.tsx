...
import digitalImg from "../Images/61069 1.png";
import DigitalTwin from "../Images/Internet of.png";
import Ellipse from "../svg/Ellipse 10.svg";
import arrow from "../svg/Arrow 1.svg";
import img1 from "../Images/IOT.jpg";
...
import hero2 from "../Images/middle.jpg";

import KeyEnhancements5GAdvanced from "@/components/KeyEnhancements5GAdvanced";
import AdvanceDimention from "@/components/AdvanceDimention";
import FiveGExplainer from "@/components/FiveGExplainer";
import FiveGAdvancedCards from "@/components/FiveGAdvancedCards";

import thumbLeft from "../Images/5ga-thumb.png";
import thumbRight from "../Images/city-grid.png";
import blob from "../Images/blop.png";
import cx from "../Images/it4.png";
import cost from "../Images/it3.png";
import data from "../Images/it2.png";
import efficiency from "../Images/it1.png";
import ImportantOfIoT from "@/components/ImportantOfIoT";
import ExamplesOfIoTApplications from "@/components/ExamplesOfIoTApplications";
import centerImg from '../Images/expofIot.jpg'
import IotTechStack from "@/components/IotTechStack";
import FutureOfIoT from "@/components/FutureOfIoT";
import RisksAndChallengesIoT from "@/components/RisksAndChallengesIoT";
...
export default function IOT() {
    ...
    const items = [
        { kind: "card", iconSrc: icon1, title: "XR (AR, VR, gaming)", desc: "Guaranteed, Seamless, Low power consumption, Edge computing" },
        { kind: "card", iconSrc: icon2, title: "Enhanced coverage", desc: "PUSCH 2 dB  •  RACH 8 dB" },
        { kind: "card", iconSrc: icon1, title: "MIMO performance", desc: "Enhanced uplink, Multi-cell uplink, +20% high speed mobile" },
        { kind: "card", iconSrc: icon2, title: "5G to replace GSM-R", desc: "Enable GSM-R migration to 5G with 5G MHz support for dedicated spectrum" },

        { kind: "card", iconSrc: icon1, title: "Evolution beyond smartphone", desc: "Reduced power/70% lower cost, 4.0 devices, Unmanned Vehicles" },
        { kind: "media", imgSrc: hero2 },
        { kind: "card", iconSrc: icon2, title: "Accurate positioning", desc: "<10 cm indoor positioning; carrier phase; complements to GNSS outdoors" },

        { kind: "card", iconSrc: icon1, title: "Resilient timing", desc: "No GPS required, timing service over 5G network" },
        { kind: "card", iconSrc: icon2, title: "Network operation efficiency", desc: "Flexible TDD spectrum use, AI/ML automation, energy efficiency" },
        { kind: "card", iconSrc: icon1, title: "Enhanced sidelink", desc: "Sidelink meeting public safety needs, XR display, etc." },
        { kind: "card", iconSrc: icon2, title: "Enhanced mobility", desc: "Reliability to 99.9%, Break from 50 to 0 ms (FR2), improved FR2 Scell setup" },
    ];
    ...
    return (
        <div className="min-h-screen flex flex-col bg-black">
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                    ...
                    <div className="space-y-5 sm:space-y-6">
                        <div>
                            <motion.h2 className="font-extrabold mb-4 sm:mb-6">
                                <span className="text-[30px] sm:text-[38px] lg:text-[44px] inline-block leading-tight">
                                    IoT
                                </span>
                            </motion.h2>
                        </div>
                        ...
                        <motion.p className="text-gray-300 text-[15px] sm:text-[16px] md:text-[18px] leading-relaxed">
                            The Internet of Things (IoT) is a network of physical devices—like appliances, vehicles,
                            wearables, and machines—embedded with sensors and software that allow them to collect,
                            share, and act on data.
                            <br /><br />
                            These “smart objects” communicate with each other and with internet-connected systems
                            to perform tasks autonomously. Examples include:
                        </motion.p>

                        <motion.ul className="mt-3 text-gray-300 text-[15px] sm:text-[16px] md:text-[18px] leading-relaxed list-disc pl-6 space-y-1">
                            <li>Monitoring farm conditions</li>
                            <li>Managing traffic via smart vehicles</li>
                            <li>Controlling industrial machinery</li>
                            <li>Tracking inventory in warehouses</li>
                        </motion.ul>
                    ...
                    >
                        <img
                            src={img1}
                            alt="Team discussion"
                            className="w-[552px] h-[568px] max-w-[560px] aspect-[552/406] object-cover rounded-lg shadow-lg transition-transform duration-500 hover:scale-[1.01]"
                        />
                    </motion.div>
                </div>
            </div>
            ...
            <ExamplesOfIoTApplications centerImg={centerImg} />
            <IotTechStack/>
            <RisksAndChallengesIoT/>
            <FutureOfIoT/>
