...
import digitalImg from "../Images/DI-Main.jpg";
import DigitalTwin from "../Images/Digital.png";
import Ellipse from "../svg/Ellipse 10.svg";
import arrow from "../svg/Arrow 1.svg";
import img1 from "../Images/Group 149.png";
                    ...
                    <div className="max-w-7xl mx-auto mt-24">
                        <div className="max-w-2xl">
                            ...
                            <motion.p className="text-white text-base md:text-[20px] leading-relaxed max-w-xl" >
                                Build for Scale. Operate with   <br></br> Confidence.
                            </motion.p>
                        </div>
                    </div>
                </div>
            ...
            <div className="text-white px-4 sm:px-8 lg:px-20 py-16">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            Your digital infrastructure isn’t just technology  it’s the engine behind transformation. HPIT delivers resilient, scalable foundations that adapt to your evolving needs  across cloud, edge, hybrid, and legacy environments.
                        </motion.p>
                        {/* Know more link */}
                        <motion.a
                            href="#"
