...
import digitalImg from "../Images/SW-main.png";
import DigitalTwin from "../Images/Seamless Wireless Integration for.png";
import Ellipse from "../svg/Ellipse 10.svg";
import arrow from "../svg/Arrow 1.svg";
import img1 from "../Images/WC.jpg";
...
import res1 from "@/Images/SW/r1.png";
import res2 from "@/Images/SW/r2.png";
import res3 from "@/Images/SW/r3.png";

import i2 from "../Images/DGT/i2.png";
import InsightSection from "@/components/InsightSection";

import i1 from "../Images/SW/i1.png";
import i2i from "../Images/SW/i2.png";
import i3 from "../Images/SW/i3.png";
...
export default function SeamlessWireless() {
    ...
    const cards = [
        {
            ...
            desc: "Integrating networks to ensure smooth and uninterrupted communication.",
        },
        {
            img: i2i,
            title: "SMART INTEGRATION",
            desc: "Bringing devices and systems together for efficient collaboration.",
        },
        {
            img: i3,
            title: "FUTURE-READY NETWORKS",
            desc: "Building wireless solutions that adapt to evolving technologies.",
        },
        {
            img: i2,
                    ...
                    <div className="max-w-7xl mx-auto mt-24">
                        <div className="max-w-2xl">
                            ...
                            <motion.p className="text-white text-base md:text-[20px] leading-relaxed max-w-xl" >
                                Unlock uninterrupted communication and next-gen <br />connectivity with our advanced wireless integration solutions tailored for modern enterprises.
                            </motion.p>
                            <div className="flex flex-wra gap-4 mt-9">
                                <button
                                    className="w-[256px] h-[54px] rounded-lg 
  ...
  w-[253px] h-[54px] border border-[#444955] rounded-lg
  py-[7px] px-[20px]
  bg-[linear-gradient(0deg,#333740,#333740),linear-gradient(179.86deg,rgba(0,0,0,0)_61.19%,rgba(29,72,173,0.2)_112.68%)]
  hover:bg-[linear-gradient(0deg,#3A3E48,#3A3E48),linear-gradient(179.86deg,rgba(0,0,0,0)_61.19%,rgba(40,90,210,0.3)_112.68%)]
  transition-all duration-300"
                                >
            ...
            <div className="text-white px-4 sm:px-8 lg:px-20 py-16">
                <div>
                    <motion.h2 className="font-extrabold mb-8">
                        <span className="text-[44px] md:text-[44px] lg:text-[44px] inline-block bg-[radial-gradient(425.56%_425.56%_at_50%_50%,_#8076F4_0%,_#FFFFFF_9.96%)] bg-clip-text text-transparent bg-center bg-[length:100%_100%] leading-tight">
                            What is Wireless<br /> Communication Integration?
                        </span>
                    </motion.h2>
                </div>
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        >
                            Wireless communication integration refers to the process of unifying various wireless technologies—such as Wi-Fi, DAS (Distributed Antenna Systems), Private LTE/5G, and IoT—into a cohesive system that ensures reliable, fast, and secure communication across your organization.
                            Whether you’re operating in a hospital, factory, office, or smart city, we ensure your wireless network supports your operations without disruption or signal loss.                                                  </motion.p>
                        {/* Know more link */}
                        <motion.a
                            href="#"
                            className="inline-flex items-center gap-2 text-white font-medium group"
                    ...
                    >
                        <img
                            src={img1}
                            alt="Team Discussion"
                            className="w-full max-w-[500px] h-auto object-cover rounded-lg shadow-lg transition-transform duration-500 hover:scale-[1.01]"
                        />
                    </motion.div>
                ...
                <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-0 py-10">
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_1fr] gap-6 items-start">
                        ...
                        >
                            ...
                            <h3 className="text-lg sm:text-xl font-semibold"> Scalable Integration</h3>
                            <p className="mt-3 text-white/75 text-sm leading-6">
                            Explore how AI is reshaping wireless infrastructure and integrated networks, driving faster, smarter communication systems.
                            </p>
                        ...
                        >
                            ...
                            <h3 className="text-lg sm:text-xl font-semibold">Unified Data Lakehouse</h3>
                            <p className="mt-3 text-white/75 text-sm leading-6">
                                Understand how a hybrid data lakehouse streamlines real-time communication, data governance, and analytics across wireless platforms.
                            </p>
